...
while True:
        ...
        ucplog.append(ucp)
        ucrlog.append(ucr)
        upalmx.append(pac_vx.upalm)
        usmcx.append(pac_vx.usrc)
...
with open("PACCircle6m_log1.txt", "w") as output:
    output.writelines(map("{};{};{};{};{};{};{};{};{};{};{};{};{};{};{};{}\n".format, tim, xpos_reflog, pos_x, ypos_reflog, pos_y, vx_uavlog, vy_uavlog, rul_vx, rul_vy, ucplog, ucrlog, rollLog, pitchLog, yawlog, upalmx,usmcx))
