...
#--------------------------------SAVING VEHICLE STATES INTO VARIABLES-------------
        ...
        # 2) Circle target
        # xpos_ref=0.0+6.0*math.cos(2*math.pi*k*dt/120)
        # ypos_ref=0.0+6.0*math.sin(2*math.pi*k*dt/120)
        ...
        # Wind disturbances
        # wind = 0.01*math.sin(2*math.pi*k*dt/1)
...
with open("PACvelocityPoint6m_wInt.txt", "w") as output:
